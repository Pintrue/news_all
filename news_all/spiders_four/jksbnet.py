...
class JianKangSBSpider(NewsRCSpider):
	...
	deny_list = [r'jksb.com.cn/html/life/baby.*?\d+.html',
	             r'jksb.com.cn/html/news/policy.*?\d+.html',
	             r'jksb.com.cn/html/news/industry.*?\d+.html',
	             r'jksb.com.cn/html/news/academic.*?\d+.html',
	             r'jksb.com.cn/html/news/knowledge.*?\d+.html',
	             r'Qpaper',
	             r'newspaper/Html'
	             ]

	rules = (Rule(LinkExtractor(allow=(
		r'jksb.com.cn/.*?%s\d{2}/\d+.html' % datetime.today().strftime('%Y/%m'),
		# http://www.jksb.com.cn/html/news/hospital/2019/1116/141009.html
		r'jksb.com.cn/.*?%s/\w+_%s\d{2}/\d+.html' % (datetime.today().strftime('%Y'),
		                                             datetime.today().strftime('%m')),
		# http://www.jksb.com.cn/html/2019/diseasenews_0418/135436.html
		r'jksb.com.cn/.*?%s-\d{2}/\d+.html' % datetime.today().strftime('%Y-%m')
		# http://www.jksb.com.cn/newspaper/Html/2019-11-05/59715.html
	),
		deny=deny_list
	),
